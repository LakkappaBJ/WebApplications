...
<body>
	<form action="logout" method="get">
		...
		<h3> Welcome to Pepperl+Fuchs</h3> <br>
		<input type="submit" value="logout" />
	</form> <br>
	
	
	
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Fill Employee Details</button>
      ...
      <div class="modal-body">
        <form  action="EmployeeDetails" method="post">
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="recipient-name" name="EmpId">
          </div>
          <div class="form-group">
